...
export default function Dashboard({ session }) {
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-md mx-auto relative bg-background border-x border-neutral-900">
      
      {/* Header */}
      <header className="p-4 border-b border-neutral-800 flex justify-between items-center sticky top-0 bg-background/80 backdrop-blur-md z-10">
        <div>
          <h1 className="font-black text-xl text-white uppercase tracking-tighter">Kuba Tracker</h1>
      ...
      <main className="flex-1 p-6 overflow-y-auto pb-24">
        ...
        <section className="mb-10">
          <h2 className="text-[10px] font-bold text-neutral-500 tracking-widest uppercase mb-4">🧘 Korekta Postawy (Codziennie)</h2>
        ...
        {/* Treningi Widget */}
        <section className="mb-10">
          <h2 className="text-[10px] font-bold text-neutral-500 tracking-widest uppercase mb-4">🏋️ Wybierz Trening</h2>
